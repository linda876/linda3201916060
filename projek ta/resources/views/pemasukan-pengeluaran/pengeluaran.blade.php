...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center mb-4">KELOLA PENGELUARAN</h1>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <a href="#" class="btn btn-primary btn-sm">TAMBAH PENGELUARAN</a>
            </div>
            <div class="card-body">
                <!--/.row-->
                            ...
                            <form method="POST" action="/pemasukan-pengeluaran/store" enctype="multipart/form-data">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input id="keterangan" type="text" class="form-control" placeholder="keterangan"
                                        name="keterangan">
                                    <input type="text" class="form-control" placeholder="keterangan" name="jenis_id"
                                        value="3" hidden>
                                </div>
                                <div class="mb-2">
                                    ...
                                    <input id="jumlah_saldo" type="text" class="form-control" name="jumlah_saldo"
                                        value="{{ $pengeluaran->saldo }}" onkeyup="sum();" placeholder="Jumlah Saldo">
                                </div>
                                <div class="mb-2">
